	...
	render({}, { characters }) {
		return (
			<main onPaste={this.onPaste}>
				...
				<footer class="foot">
					<p class="localthreat">
						<a href="/">localthre.at</a> &copy; 2017 Arthur Corenzan &middot; <a href="https://github.com/haggen/localthre.at" target="blank" rel="noopener noreferrer">GitHub</a> &middot; Tips go to <a href="https://zkillboard.com/character/95036967/" target="blank" rel="noopener noreferrer">Jason Chorant</a>
					</p>
